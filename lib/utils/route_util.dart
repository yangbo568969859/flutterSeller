...
class RouteUtil {
  ...
  static void routeToGoodsList(BuildContext context) {
    Navigator.of(context).push(FadeRouteBuilder(page: GoodsList()));
  }

  /// 退款管理页面
  static void routeToRefundList(BuildContext context) {
    Navigator.of(context).push(FadeRouteBuilder(page: RefundsList()));
  }

  /// 订单页面
  static void routeToOrderList(BuildContext context, {int type}) {
    Navigator.of(context).push(FadeRouteBuilder(page: OrdersList(type: type)));
  }

  /// 订单详情页面
  static void routeToOrderDetailPage(BuildContext context, id) {
    Navigator.of(context).push(FadeRouteBuilder(page: OrderDetail(id: id)));
  }
  ...
  static void routeToGoodsEditPage1(BuildContext context) {
    Navigator.of(context).push(FadeRouteBuilder(page: GoodsEditPage()));
  }

  /// 消息通知主页面
  static void routeToMessageSettingPage(BuildContext context) {
    Navigator.of(context).push(FadeRouteBuilder(page: MessageSetting()));
  }

  /// 去设置主页面
  static void routeToSettingPage(BuildContext context) {
    Navigator.of(context).push(FadeRouteBuilder(page: Setting()));
  }

  /// 去消息主页面
  static void routeToMessagePage(BuildContext context) {
    Navigator.of(context).push(FadeRouteBuilder(page: MessagePage()));
  }

  /// 区消息列表页面
  static void routeToMessageListPage(BuildContext context,
      {String title, String pageId}) {
    Navigator.of(context).push(
        FadeRouteBuilder(page: MessageListPage(title: title, pageId: pageId)));
  }

  /// 店铺设置页面
  static void routeToStoreManagePage(BuildContext context) {
    Navigator.of(context).push(FadeRouteBuilder(page: StoreManage()));
  }

  static void routeToStoreThemeDetail(BuildContext context) {
    Navigator.of(context).push(FadeRouteBuilder(page: StoreThemeDetail()));
  }

  static void routeToStoreThemeImage(BuildContext context) {
    Navigator.of(context).push(FadeRouteBuilder(page: StoreThemeImage()));
  }

  /// 邀请页面
  static void routeToInviteCustom(BuildContext context) {
    Navigator.of(context).push(FadeRouteBuilder(page: InviteCustom()));
  }

  /// 收货仓管理页面
  static void routeToReceivingWarehouseManage(BuildContext context,
      {int type}) {
    Navigator.of(context)
        .push(FadeRouteBuilder(page: ReceivingWarehouseManage(type: type)));
  }

  /// 退货仓管理页面
  static void routeToReturnWarehouseManage(BuildContext context) {
    Navigator.of(context).push(FadeRouteBuilder(page: ReturnWarehouseManage()));
  }

  /// 店铺仓管理页面
  static void routeToStoreDecoration(BuildContext context) {
    Navigator.of(context).push(FadeRouteBuilder(page: StoreDecoration()));
  }
  ...
  static pushResult(
    ...
    Navigator.of(context).push(FadeRouteBuilder(page: scene)).then((result) {
      // 页面返回result为null
      if (result == null) {
        return;
      }

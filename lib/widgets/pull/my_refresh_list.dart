    ...
    return SafeArea(
      child: NotificationListener(
        ...
        child: RefreshIndicator(
          ...
          child: widget.itemCount == 0 ? EmptyPage(type: widget.stateType) : ListView.builder(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Text(hasMore ? '正在加载中...' : (itemCount < pageSize ? '' : '已经到底了'), style: const TextStyle(fontSize: 12, color: const Color(0x8A000000))),
        ],
      ),
    );
  }

        ...
        child: Row(
          children: <Widget>[
            ClipRRect(
              ...
              child: Image.network(
                  'https://img.aqsea.com/wl/avatar/20190823143054255-1217564382.PNG',
                  width: 50,
                  height: 50),
            ),
            SizedBox(width: 10),
...
//            pinned: true, // 设置为true就会固定在顶部
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              title: Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Text('客户总数',
                        style:
                            TextStyle(color: Color(0xFF3233F3), fontSize: 12)),
                    Gaps.hGap12,
                    Text('0',
                        style:
                            TextStyle(color: Color(0xFF3233F3), fontSize: 12))
              ...
              background: Image.network(
                'http://w.kl.126.net/public/mykaola-mobile/6d111bc9fc56e0026c4093e47e330116.png',
                fit: BoxFit.cover,
              ),
            ),
            actions: <Widget>[
